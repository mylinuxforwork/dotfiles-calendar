...
# Header
_sep
echo "Setup ML4W Dotfiles Calendar"
...
wget -q -P "$HOME/.cache" "https://github.com/mylinuxforwork/dotfiles-calendar/releases/latest/download/com.ml4w.calendar.flatpak"
cd "$HOME/.cache"
echo ":: Installing com.ml4w.calendar.flatpak"
eval "flatpak --user -y --reinstall install com.ml4w.calendar.flatpak > $cmdoutput"
rm "$HOME/.cache/com.ml4w.calendar.flatpak"
